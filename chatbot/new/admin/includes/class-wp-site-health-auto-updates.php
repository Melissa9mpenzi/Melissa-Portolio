...
class WP_Site_Health_Auto_Updates {
	...
	public function test_filters_automatic_updater_disabled() {
		/** This filter is documented in admin/includes/class-wp-automatic-updater.php */
	...
	public function test_wp_automatic_updates_disabled() {
		if ( ! class_exists( 'WP_Automatic_Updater' ) ) {
			require_once ABSPATH . 'admin/includes/class-wp-automatic-updater.php';
		}
	...
	public function test_accepts_dev_updates() {
		...
		/** This filter is documented in admin/includes/class-core-upgrader.php */
