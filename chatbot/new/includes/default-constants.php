...
function wp_initial_constants() {
	 ...
	 * define( 'WP_DEVELOPMENT_MODE', 'theme' ), or define( 'WP_DEVELOPMENT_MODE', 'all' ) to config.php
	...
	// Add define( 'WP_DEBUG', true ); to config.php to enable display of notices during development.
	if ( ! defined( 'WP_DEBUG' ) ) {
	...
	/*
	 * Add define( 'WP_DEBUG_DISPLAY', null ); to config.php to use the globally configured setting
	...
	/*
	 * Add define( 'SCRIPT_DEBUG', true ); to config.php to enable loading of non-minified,
