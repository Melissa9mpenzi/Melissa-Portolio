...
function wp_ajax_imgedit_preview() {
	...
	require_once ABSPATH . 'admin/includes/image-edit.php';
...
function _wp_ajax_add_hierarchical_term() {
	...
	/** This filter is documented in admin/includes/meta-boxes.php */
...
function wp_ajax_add_tag() {
	...
	require ABSPATH . 'admin/includes/edit-tag-messages.php';
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in admin/includes/class-wp-posts-list-table.php */
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in admin/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in admin/includes/class-custom-image-header.php */
...
function wp_ajax_health_check_get_sizes() {
	...
	if ( ! class_exists( 'WP_Debug_Data' ) ) {
		require_once ABSPATH . 'admin/includes/class-wp-debug-data.php';
	}
...
function wp_ajax_toggle_auto_updates() {
	...
	switch ( $type ) {
		case 'plugin':
			...
			/** This filter is documented in admin/includes/class-wp-plugins-list-table.php */
