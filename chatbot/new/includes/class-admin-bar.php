...
class WP_Admin_Bar {
	...
	final protected function _render_container( $node ) {
		...
		echo '<div id="' . esc_attr( 'admin-bar-' . $node->id ) . '" class="ab-group-container">';
	...
	final protected function _render_group( $node, $menu_title = false ) {
		...
		if ( empty( $menu_title ) ) {
			echo "<ul role='menu' id='" . esc_attr( 'admin-bar-' . $node->id ) . "'$class>";
		} else {
			echo "<ul role='menu' aria-label='" . esc_attr( $menu_title ) . "' id='" . esc_attr( 'admin-bar-' . $node->id ) . "'$class>";
		}
	...
	final protected function _render_item( $node ) {
		...
		if ( ! $is_root_top_item && ! $is_top_secondary_item && $is_parent ) {
			$arrow = '<span class="admin-bar-arrow" aria-hidden="true"></span>';
		}
		...
		echo "<li role='group' id='" . esc_attr( 'admin-bar-' . $node->id ) . "'$menuclass>";
