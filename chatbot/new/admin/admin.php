...
if ( get_option( 'db_upgraded' ) ) {
	 ...
	 *
	 * In single site, the user would be redirected to admin/upgrade.php.
	...
	if ( apply_filters( 'do_mu_upgrade', true ) ) {
		...
		if ( $blog_count <= 50 || ( $blog_count > 50 && mt_rand( 0, (int) ( $blog_count / 50 ) ) === 1 ) ) {
			...
			/** This action is documented in admin/network/upgrade.php */
 ...
 * $wp_importers is sometimes set in admin/includes/import.php.
...
if ( WP_NETWORK_ADMIN ) {
	require ABSPATH . 'admin/network/menu.php';
} elseif ( WP_USER_ADMIN ) {
	require ABSPATH . 'admin/user/menu.php';
} else {
