 ...
 *
 * @since 2.8.0
 * @since 4.6.0 Moved to its own file from admin/includes/class-wp-upgrader.php.
 *
 * @see WP_Upgrader
 */
class Core_Upgrader extends WP_Upgrader {
	...
	public function upgrade( $current, $args = array() ) {
		...
		if ( ! $wp_filesystem->copy( $working_dir . '/wordpress/admin/includes/update-core.php', $wp_dir . 'admin/includes/update-core.php', true ) ) {
			$wp_filesystem->delete( $working_dir, true );
			WP_Upgrader::release_lock( 'core_updater' );
			return new WP_Error( 'copy_failed_for_update_core_file', __( 'The update cannot be installed because some files could not be copied. This is usually due to inconsistent file permissions.' ), 'admin/includes/update-core.php' );
		}
		$wp_filesystem->chmod( $wp_dir . 'admin/includes/update-core.php', FS_CHMOD_FILE );

		wp_opcache_invalidate( ABSPATH . 'admin/includes/update-core.php' );
		...
		/** This action is documented in admin/includes/class-wp-upgrader.php */
		do_action(
