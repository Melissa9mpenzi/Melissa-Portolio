...
function wp_insert_user( $userdata ) {
	...
	if ( ! $update ) {
		/** This action is documented in includes/pluggable.php */
...
function retrieve_password( $user_login = '' ) {
	 ...
	 */
	$message .= network_site_url( 'login.php?login=' . rawurlencode( $user_login ) . "&key=$key&action=rp", 'login' ) . '&wp_lang=' . $locale . "\r\n\r\n";
