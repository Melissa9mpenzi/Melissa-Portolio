...
function _unzip_file_pclzip( $file, $to, $needed_dirs = array() ) {
	...
	/** This filter is documented in src/admin/includes/file.php */
	$pre = apply_filters( 'pre_unzip_file', null, $file, $to, $needed_dirs, $required_space );
	...
	/** This action is documented in src/admin/includes/file.php */
	$result = apply_filters( 'unzip_file', true, $file, $to, $needed_dirs, $required_space );
...
function WP_Filesystem( $args = false, $context = false, $allow_relaxed_file_ownership = false ) { // phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionNameInvalid
	...
	require_once ABSPATH . 'admin/includes/class-wp-filesystem-base.php';
	...
	if ( ! class_exists( "WP_Filesystem_$method" ) ) {
		 ...
		 */
		$abstraction_file = apply_filters( 'filesystem_method_file', ABSPATH . 'admin/includes/class-wp-filesystem-' . $method . '.php', $method );
 ...
 *
 * The return value can be overridden by defining the `FS_METHOD` constant in `config.php`,
