		...
		<td>
			...
			if ( defined( 'WPLANG' ) && ( '' !== WPLANG ) && WPLANG !== $locale ) {
				_deprecated_argument(
					'define()',
					'4.0.0',
					/* translators: 1: WPLANG, 2: config.php */
					sprintf( __( 'The %1$s constant in your %2$s file is no longer needed.' ), 'WPLANG', 'config.php' )
				);
			}
			?>
		</td>
...
<?php require_once ABSPATH . 'admin/admin-footer.php'; ?>
