...
require_once ABSPATH . 'admin/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH . 'admin/includes/class-wp-internal-pointers.php';
...
<div class="hidden" id="inline_' . $post->ID . '">
	...
	/** This filter is documented in admin/edit-tag-form.php */
...
var ajaxurl = '<?php echo esc_js( admin_url( 'admin-ajax.php', 'relative' ) ); ?>',
	...
	?>
<body <?php echo $admin_body_id; ?>class="admin wp-core-ui no-js iframe <?php echo esc_attr( $admin_body_classes ); ?>">
<script type="text/javascript">
(function(){
