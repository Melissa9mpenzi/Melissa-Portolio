...
if ( function_exists( 'error_reporting' ) ) {
	 ...
	 *
	 * This will be adapted in wp_debug_mode() located in includes/load.php based on WP_DEBUG.
...
/*
 * If config.php exists in the WordPress root, or if it exists in the root and settings.php
